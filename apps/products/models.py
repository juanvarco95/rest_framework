...
class CateroryProduct(BaseModel):

    description = models.CharField('Descripción', max_length = 50, blank = False, null = False)
    measure_unit = models.ForeignKey(MeasureUnit, on_delete= CASCADE, verbose_name = 'Unidad de Medida')
    historical = HistoricalRecords()
...
class Indicador(BaseModel):
    ...
    category_product = models.ForeignKey(CateroryProduct, on_delete = CASCADE, verbose_name = 'Indicador de Oferta')  
    historical =  HistoricalRecords()
